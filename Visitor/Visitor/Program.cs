    ...
    class Program
    {
        ...
        {
            new Car() { CarName = "A1", Price = 200M, CarType = "Mercedes" },
            new Car() { CarName = "A2", Price = 100M, CarType = "Normal" },

            new Bike() { BikeName = "B1", Price = 50M, BikeType = "Bullet" },
            new Bike() { BikeName = "B2", Price = 30M, BikeType = "Normal" }
        };
